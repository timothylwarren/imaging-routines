...
data_path='/Volumes/LaCie/2pdata/march28/wt/animal5/'
files_to_plot=['---Streaming Phasor Capture - 8_XY0_Z0_T000_C0.tif','---Streaming Phasor Capture - 3_XY0_Z0_T000_C0.tif']
stim_frame={}
stim_frame['on']=[552,555]
stim_frame['off']=[476,476]
stim_ind={}
stim_ind['on']=6
stim_ind['off']=5
pre_time_in_sec=5
