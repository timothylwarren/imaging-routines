...
data_path= '/Volumes/LaCie/2pdata/march28/unc-5/animal5/'
...
pck_name='--Streaming Phasor Capture - 9_XY0_Z0_T000_C0.tif.pck'
#file_name=['2x 10 micron diam z-stack20space seperation  - 1_XY1553116792_Z000_T0_C0.tif']
microns_per_pixel=1.47441
off_target_centers=[[165,182],[220,206]]
on_target_centers=[[182.5,184],[192.5,189]]
...
for crind in np.arange(len(file_names)):
    ...
    y[yvls,xvls]=1
    y=np.ma.masked_where(y==0,y)
    ax[crind].set_xlim(120,250)
    ax[crind].set_ylim(120,250)
