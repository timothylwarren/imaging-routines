...
data_path= '/Volumes/LaCie/2pdata/march26/animal4/'
...
pck_name='---Streaming Phasor Capture - 8_XY0_Z0_T0000_C0.tif.pck'
#file_name=['2x 10 micron diam z-stack20space seperation  - 1_XY1553116792_Z000_T0_C0.tif']
microns_per_pixel=1.47441
on_target_centers=[[183,168],[195,170]]
off_target_centers=[[190,168],[193,153]]
...
for crind in np.arange(len(file_names)):
    ...
    circ=plt.Circle((cr_center[0],cr_center[1]),radius=5/microns_per_pixel,edgecolor='b',facecolor='None')
