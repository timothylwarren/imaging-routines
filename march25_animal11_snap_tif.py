...
data_path= '/Volumes/LaCie/2pdata/march25/animal11/'
...
pck_name='-----Streaming Phasor Capture - 2_XY0_Z0_T0000_C0.tif.pck'
...
for crind in np.arange(len(file_names)):
    ...
    ax[crind].imshow(y,cmap='Reds',alpha=0.3,interpolation='nearest')
