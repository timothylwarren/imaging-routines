...
pck_name='---Streaming Phasor Capture - 4 - 1_XY0_Z0_T0000_C0.tif.pck'
...
for crind in np.arange(len(file_names)):
    ...
    ax[crind].set_xlim(140,220)
    ax[crind].set_ylim(140,220)
    imobj.set_clim(100,900)
    imobj=ax[crind+2].imshow(dt['tifstack'])
    imobj.set_clim(100,900)
    #imobj.set_clim(200,2000)
    ax[crind+2].set_xlim(140,220)
    ax[crind+2].set_ylim(140,220)
