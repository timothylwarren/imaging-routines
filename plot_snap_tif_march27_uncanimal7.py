...
data_path= '/Volumes/LaCie/2pdata/march27_unc-5/animal7/'
...
file_names=['Snap image - 8_XY0_Z0_T0_C0.tif','Snap image - 9_XY0_Z0_T0_C0.tif']
...
off_target_centers=[[220,222],[213,239]]
...
for crind in np.arange(len(file_names)):
    ...
    y[yvls,xvls]=1
    y=np.ma.masked_where(y==0,y)
    ax[crind].set_xlim(50,350)
    ax[crind].set_ylim(50,350)
